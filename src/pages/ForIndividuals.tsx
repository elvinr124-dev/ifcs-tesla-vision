    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-24 px-6 md:px-12 content-bg-alt">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-sm font-semibold tracking-[0.25em] uppercase text-accent mb-3">Our Services</p>
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-foreground">What We Offer</h2>
          </div>
