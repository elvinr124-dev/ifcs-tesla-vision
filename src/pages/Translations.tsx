    ...
    <div className="bg-background min-h-screen">
      ...
      <section className="border-b border-border content-bg-alt">
        <div className="max-w-6xl mx-auto px-6 md:px-12 py-8 grid grid-cols-2 md:grid-cols-5 gap-6">
          ...
          <div className="flex items-center gap-3">
            <img alt="American Translators Association" className="h-6 shrink-0 object-contain" style={{ filter: "brightness(0) saturate(100%) invert(36%) sepia(96%) saturate(1200%) hue-rotate(209deg) brightness(95%) contrast(95%)" }} src={logoAta} />
