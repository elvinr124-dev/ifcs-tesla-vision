    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-28 pb-24 px-6 md:px-12 max-w-3xl mx-auto">
        <div className="rounded-3xl bg-accent text-accent-foreground p-10 md:p-14 text-center space-y-6">
          ...
          <h1 className="text-3xl md:text-4xl font-bold">Order Successful!</h1>
          <div className="space-y-2">
            <p className="text-lg opacity-90">Application ID</p>
          ...
          {state.totalPrice !== undefined && (
            <p className="text-lg font-semibold">Total: ${state.totalPrice.toFixed(2)}</p>
          )}
          {state.email && (
        ...
        <div className="mt-8 text-center space-y-4">
          <p className="text-muted-foreground">
            Your order has been added to your dashboard. You can track its progress and view your application details there.
          </p>
